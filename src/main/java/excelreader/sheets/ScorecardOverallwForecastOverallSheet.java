...
public class ScorecardOverallwForecastOverallSheet extends Sheets {

	private static Logger logger = Logger.getLogger(SubAccountSheet.class);
	ApplicationProperties properties = null;

	public ScorecardOverallwForecastOverallSheet(ApplicationProperties properties) {
		this.properties = properties;
	}

	public int processScorecardOverallwForecastOverallSheet(Sheet sheet) {
		...
		for (Row row : sheet) {
			...
			if (ITNName.equalsIgnoreCase("ITN Name"))
			{
				break;
			}
